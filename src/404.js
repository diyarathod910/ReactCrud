            ...
            <div>
                ...
                <div className="w-full flex justify-center py-10">
                    <div className="w-[80%] flex gap-2 items-center ">
                        ...
                        <a href="notfound" className="font-[Poppins] text-[14px] font-regular text-[#000000]">
                            404 Error
                        </a>
                    </div>
                </div>
                <div className="w-[100%] flex justify-center items-center flex-col gap-[30px]">
                    <p className="font-[Inter] font-medium text-[110px] text-[#000000]">
                        404 Not Found
                    </p>
                    <p className="font-[Poppins] font-regular text-[16px] text-[#000000]">
                        Your visited page not found. You may go home page.
                    </p>
                    <button className="w-[30%] p-5 bg-[#DB4444] font-[Poppins] font-medium text-[16px] text-[#FAFAFA] mt-8">
                        Back to home page
                    </button>
                </div>
                {/* footer */}
